...
# You might need to remove that in production
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'authentication.password_validation.NumberValidator',
    },
    {
        'NAME': 'authentication.password_validation.UppercaseValidator'
    }
]
